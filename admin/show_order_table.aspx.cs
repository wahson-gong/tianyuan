...
public partial class admin_show_auto_table : System.Web.UI.Page
{
   ...
   public my_basic my_b = new my_basic();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            DataTable Model_dt = my_c.GetTable("select * from " + ConfigurationSettings.AppSettings["Prefix"].ToString() + "Field where u13<>'是' and Model_id=" + Request.QueryString["Model_id"].ToString() + "  order by u9,id");
