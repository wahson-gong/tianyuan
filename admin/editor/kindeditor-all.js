	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function createView(result) {
			...
			for (var i = 0, len = fileList.length; i < len; i++) {
				...
				var img = K('<img src="' + iconUrl + '"  style="width:80px" height="80" alt="' + data.filename + '" />');
				if (!data.is_dir || data.has_file) {
...
K.extend(KSWFUpload, {
	...
	appendFile : function(file) {
		...
		var img = K('<img src="' + file.url + '" class="ke-img" data-status="' + file.filestatus + '"  style="width:80px" height="80" alt="' + file.name + '" />');
		photoDiv.append(img);
