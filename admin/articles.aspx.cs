...
public partial class admin_articles : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Literal2.Text = db.set_list(t1, dt2, dt1, i, "", "articles_add.aspx?Model_id=" + Request.QueryString["Model_id"].ToString() + "&classid=" + Request.QueryString["classid"].ToString() + "");
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("articles.aspx?Model_id=" + Request.QueryString["Model_id"].ToString() + "&classid=" + classid + "&u1=" + my_b.c_string(this.TextBox3.Text) + "&shenhe=" + this.DropDownList1.SelectedValue.Replace("全部", "") + "&shijian1=" + this.TextBox1.Text + "&shijian2=" + this.TextBox2.Text + "");
    }
}
