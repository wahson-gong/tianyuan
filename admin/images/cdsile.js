...
init = function() {
	...
	// 初始化菜单列表
	Menus = {
		"内容管理" :	{"row" : 2, "show" : true, "menu" : {"单页面管理" : "shop_Single.aspx","基础设置" : "articles.aspx?Model_id=1","平台前端" : "articles.aspx?Model_id=2","店铺管理" : "auto_table.aspx?Model_id=5"}},"用户管理" :	{"row" : 1, "show" : true, "menu" : {"管理员管理" : "admin_table.aspx"}},"系统管理" :	{"row" : 2, "show" : true, "menu" : {"参数管理" : "Parameter.aspx","系统日志" : "Web_Blog.aspx","网站配置" : "Config.aspx","模型管理" : "Model.aspx"}},"扩展管理" :	{"row" : 2, "show" : true, "menu" : {"广告管理" : "Ad_Table.aspx","配置管理" : "peizhi_table.aspx","SQL server" : "sql_back.aspx"}}
