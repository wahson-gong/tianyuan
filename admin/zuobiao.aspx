<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zuobiao.aspx.cs" Inherits="admin_zuobiao" %>
...
<body>
   <div id="preview">
    ...
    <div id="result" style="margin-top: 4px;"></div><input type="button" onclick="get_ditu()" value="获取坐标" />
    <script type="text/javascript">
        function get_ditu() {
            if (document.getElementById('result').innerHTML == "") {
                ...
                window.parent.document.all('<%=editname %>').value = document.getElementById('result').innerHTML;
               // alert(window);
                window.close();
            }
        }
    ...
    <script type="text/javascript">
        ...
        var para = getUrlParas(),
            center = para.address ? decodeURIComponent(para.address) : "思乐科技",
            city = para.city ? decodeURIComponent(para.city) : "成都市";
        ...
        var marker = new BMap.Marker(new BMap.Point(104.063482, 30.646972), {
        ...
        */
        ...
        function setheight() {
              window.parent.document.all('<%=editname %>_').height = document.body.scrollHeight;
        }
