...
public partial class admin_Order_table : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Literal2.Text = db.set_list(t1, dt2, dt1, i, "", "user_table_add.aspx?Model_id=" + Request.QueryString["Model_id"].ToString() + "");
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        try
        {
            Response.Redirect("user_table.aspx?Model_id=" + Request.QueryString["Model_id"].ToString() + "&laiyuanbianhao=" + Request.QueryString["laiyuanbianhao"].ToString() + "&u1=" + my_b.c_string(this.TextBox3.Text) + "&leixing=" + DropDownList1.SelectedValue + "&jihuo=" + DropDownList2.SelectedValue + "&shijian1=" + this.TextBox1.Text + "&shijian2=" + this.TextBox2.Text + "");
        }
        catch
        {
            Response.Redirect("user_table.aspx?Model_id=" + Request.QueryString["Model_id"].ToString() + "&u1=" + my_b.c_string(this.TextBox3.Text) + "&jihuo=" + DropDownList2.SelectedValue + "&leixing=" + DropDownList1.SelectedValue + "&shijian1=" + this.TextBox1.Text + "&shijian2=" + this.TextBox2.Text + "");
        }
    }
}
