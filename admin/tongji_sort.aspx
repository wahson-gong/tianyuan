<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tongji_sort.aspx.cs" Inherits="admin_Ad_Table" %>
...
function selcheck(id) {
   ...
   if (e.checked){
     ...
     <div id="frame_Toolbar" class="toolbarBg"> 
	    ...
	    <div id="guide"> 您现在的位置：统计分析 >> 栏目信息统计</div>
	...
	<div id="content">
     ...
     <table class="cTable table tCenter">
	    <tr class="cTitle toolbarBg" id="Title">
		    ...
		    <td width="20%"><span class="split ctSplit"></span><div>栏目名 </div></td>
	...
	<table class="cTable table tCenter" cellspacing="0" border="0" style="border-collapse:collapse;">
		...
		<tr>
			...
			<td style="width:20%;"><%#DataBinder.Eval(Container.DataItem, "u1").ToString()%></td>
			<td style=" text-align:left"><%#my_b.get_count("sl_wenzhang","where fenlei like '%"+DataBinder.Eval(Container.DataItem, "id").ToString()+"%'")%></td>
