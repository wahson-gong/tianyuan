...
public partial class admin_articles_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (type == "del")
        {
            ...
            my_b.tiaozhuan("删除信息成功！马上跳转到信息列表页面！", "product_table.aspx?classid=" + Request.QueryString["classid"].ToString() + "&Model_id=" + Request.QueryString["Model_id"].ToString() + "");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        if (type == "edit")
        {
            Response.Redirect("err.aspx?err=增加信息成功！马上跳转到信息列表页面！&errurl=" + my_b.tihuan("product_table.aspx?classid=" + Request.QueryString["classid"].ToString() + "&Model_id=" + Request.QueryString["Model_id"].ToString() + "", "&", "fzw123") + "");
        }
        else
        {
            Response.Redirect("err.aspx?err=增加信息成功！马上跳转到信息列表页面！&errurl=" + my_b.tihuan("product_table.aspx?classid=" + Request.QueryString["classid"].ToString() + "&Model_id=" + Request.QueryString["Model_id"].ToString() + "", "&", "fzw123") + "");
