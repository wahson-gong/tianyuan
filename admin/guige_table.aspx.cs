...
public partial class admin_Fields : System.Web.UI.Page
{
    ...
    public void set_listpage(string biaoming,string type)
    {
        ...
        if (type == "")
        {
            Literal1.Text = db.set_duo_list(t1, dt2, dt1, i, "", "guige_table_add.aspx?Model_id=" + model_id + "&editname=" + Request.QueryString["editname"].ToString() + "&classid=" + Request.QueryString["classid"].ToString() + "");
        }
        else
        {
            Response.Write(db.set_duo_list(t1, dt2, dt1, i, "", "guige_table_add.aspx?Model_id=" + model_id + "&editname=" + Request.QueryString["editname"].ToString() + "&classid=" + Request.QueryString["classid"].ToString() + ""));
            Response.End();
        }
