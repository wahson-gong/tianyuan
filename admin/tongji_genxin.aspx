<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tongji_genxin.aspx.cs" Inherits="admin_Ad_Table" %>
   ...
   if (e.checked){
	...
	<div id="content">
     ...
     <table class="cTable table tCenter">
	    <tr class="cTitle toolbarBg" id="Title">
		    ...
		    <td width="20%"><span class="split ctSplit"></span><div>年份 </div></td>
	...
	<table class="cTable table tCenter" cellspacing="0" border="0" style="border-collapse:collapse;">
		...
		<tr>
			...
			<td style=" text-align:left"><%#my_b.get_count("sl_wenzhang","where dtime like '%"+DataBinder.Eval(Container.DataItem, "u1").ToString()+"%'")%></td>
