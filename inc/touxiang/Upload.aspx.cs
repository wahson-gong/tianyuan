    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Result result = new Result();
			...
			if (file != null) 
			{
				...
				result.sourceUrl = string.Format(mulu + "csharp_source_{0}.{1}", fileName, sourceExtendName);
			...
			for ( int i = 0; i < avatars_length; i++ )
			{
				...
				string virtualPath = string.Format(mulu + "csharp_avatar{0}_{1}.jpg", avatar_number, fileName);
