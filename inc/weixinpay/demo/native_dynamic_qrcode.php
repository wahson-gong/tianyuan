...
*/
	...
	logger("unifiedOrderResult ".implode(',',$unifiedOrderResult));
...
<!--        <p>订单号：--><?php //echo $_GET['dingdanhao']; ?><!--</p>-->
	...
	<script>
		if(<?php echo $unifiedOrderResult["code_url"] != NULL; ?>)
		{
			...
			wording.innerHTML = "总金额为"+<?php echo $_GET['jine'];?>;
...
//            element.appendChild(wording);
		...
		function chadan(){
			$.ajax({
					type: "GET",
					url: "/single.aspx?m=chadan&danhao=<?php echo $_GET['dingdanhao']; ?>&tablename=<?php echo $_GET['tablename'];?>",
					processData:true,
					success: function(data){
					//alert(data);
						if (data=="已付款"){
							clearInterval(chd);
							window.location.href="/err.aspx?err=恭喜，已经付款成功-即将进入个人中心。&errurl=/";
