<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ditu.aspx.cs" Inherits="inc_ditu" %>
...
<body>
   <div id="preview">
    ...
    function get_ditu()
    {
        ...
        {
            window.opener.document.all('<%=editname %>').value=document.getElementById('result').innerHTML;
            window.close();
        }
    }
    </script>
